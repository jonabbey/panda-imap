/*
 * Program:	Network News Transfer Protocol (NNTP) client routines - VMS
 *
 * Author:	Mark Crispin
...

  ...
  fclose (nf);			/* close new file */
				/* rename new database to current */
  if (rename (NEWNEWSRC,NEWSRC)) {
