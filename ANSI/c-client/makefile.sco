# Program:	Portable C client makefile -- SCO version
#
...
CFLAGS =
LDFLAGS = -lsocket -lcrypt -lx -lprot
...
c-client.a: mail.o bezerk.o tenex.o mbox.o mh.o imap2.o news.o nntpclient.o \
	dummy.o smtp.o nntp.o rfc822.o misc.o osdep.o sm_unix.o
	rm -f c-client.a
	ar rc c-client.a mail.o bezerk.o tenex.o mbox.o mh.o imap2.o news.o \
	nntpclient.o dummy.o smtp.o nntp.o rfc822.o misc.o osdep.o sm_unix.o
