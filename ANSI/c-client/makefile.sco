...
c-client.a: mail.o mmdf.o tenex2.o mbox.o mh.o imap2.o news.o nntpclient.o \
	phile.o dummy.o smtp.o nntp.o rfc822.o misc.o osdep.o sm_unix.o
	rm -f c-client.a
	ar rc c-client.a mail.o mmdf.o tenex2.o mbox.o mh.o imap2.o news.o \
...
mbox.o: mail.h mbox.h mmdf.h misc.h osdep.h
