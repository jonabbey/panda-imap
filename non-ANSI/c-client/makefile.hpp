...
osdep.o: mail.h osdep.h env_unix.h fs.h ftl.h nl.h tcp.h os_hpp.c fs_unix.c \
	ftl_unix.c nl_unix.c env_unix.c tcp_unix.c log_std.c flock.c \
	utimes.c strerror.c strstr.c strtol.c
	$(CC) $(CFLAGS) $(OSDEFS) -c os_hpp.c
	mv os_hpp.o osdep.o
