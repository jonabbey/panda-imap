# Program:	IMAP Makefile - SCO version
#
# Author:	Mark Crispin
...
all:
	...
	ln -s ANSI systype
	cd systype/c-client; ln -s makefile.sco Makefile; make
	cd ms;make
	cd ipopd;make
	cd imapd;make
...
clean:
	...
	cd ANSI/c-client;make -f makefile.sco clean
	cd non-ANSI/imapd;make clean
	cd non-ANSI/ipopd;make clean
	cd non-ANSI/ms;make clean
	cd non-ANSI/c-client;make -f makefile.bsd clean
